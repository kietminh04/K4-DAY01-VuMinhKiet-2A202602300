...
- Một record (`instance_id`, `class_name`, `score`, số điểm và một phần `polygon_xy`):
  ...
  * **Mô tả đa giác bằng lời:** Đa giác gồm 348 điểm đỉnh khép kín, uốn lượn liên tục bám sát từng đường biên ngoại hình thực tế của người đầu bếp: bắt đầu từ chỏm đầu/tóc ở tọa độ pixel `[446.0, 70.0]`, bo viền theo bờ vai, vòng xuống dọc theo hai cánh tay và nếp gấp tạp dề trắng, ôm sát dây đeo lưng (suspenders), men theo viền hai ống quần dài xuống đến gót giày và khép kín lại thành một vùng mặt nạ liên tục.
